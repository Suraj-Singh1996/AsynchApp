...
public class AdvancedJpaApplication implements CommandLineRunner {
	...
	private void dispPagination() {
		...
		/*
		 * System.out.println("Pagination without Sorting"); List<Person> noSortList =
		 * personService.findByLastName("Singh", PageRequest.of(0, 1));
		 * 
		 * noSortList.forEach(System.out::println);
		 */
		
		System.out.println("First Page");
		Iterable<Person> list = personService.findByLastName("Singh", PageRequest.of(0, 2, Direction.ASC, "firstName"));
		
		list.forEach(System.out::println);
		
		System.out.println("Secound Page");
		Iterable<Person> list2 = personService.findByLastName("Singh", PageRequest.of(1, 2, Direction.DESC, "firstName"));
